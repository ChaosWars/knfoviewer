...
QByteArray CP437Codec::name() const
{
    return QByteArray( "CP437" );
}

QList< QByteArray > CP437Codec::aliases() const
{
...
QByteArray CP437Codec::convertFromUnicode( const QChar*, int, ConverterState* ) const
{
    return QByteArray();
}

QString CP437Codec::convertToUnicode( const char * chars, int len, ConverterState * ) const
{
    QString result;
